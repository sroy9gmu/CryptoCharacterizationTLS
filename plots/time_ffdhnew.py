...
times = {
    'OpenSSL': (1688307.0, 34664.27, 5.09, 16.156222),
    # 'OpenSSL': (max(38191.548417, 94037.0, 52094.0), 34664.27, 58.0, 16.156222),
...
durs = {
    ...
    'FFDH-2048': (max(38191.548417, 94037.0, 52094.0), 38191.548417, 94037.0, 52094.0),
    'RSA-PSS-3072': (34664.27, 35588.0, 42559.0, 54453.0),
    'AES-128-GCM': (5.09, 66.0, 45.0, 86.0),
