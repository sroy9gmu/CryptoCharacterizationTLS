...
Steps   
    ...
    6. Start server and client in separate windows
        ...
        FFDH, RSA-PSS:  
        ./ssl_server2 ca_file=3b+/rsa_cert.pem crt_file=3b+/rsa_srv_cert.pem key_file=3b+/rsa_srv_pvt.pem dhm_file=3b+/dh_param.pem groups="ffdhe2048" force_version=tls13 tls13_kex_modes=ephemeral_all force_ciphersuite=TLS1-3-AES-128-GCM-SHA256

        ./ssl_client2 ca_file=3b+/rsa_cert.pem crt_file=3b+/rsa_cli_cert.pem key_file=3b+/rsa_cli_pvt.pem groups="ffdhe2048" force_version=tls13 tls13_kex_modes=ephemeral_all force_ciphersuite=TLS1-3-AES-128-GCM-SHA256
